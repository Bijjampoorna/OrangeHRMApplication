...
public class LoginPageUsingIF extends BaseTest
{
...
//VALIDATING LOGIN PANEL TITLE
				...
				By loginPanelElement=By.id(proFile.getProperty("loginPanelElement"));
...
//VALIDATING ORANGE HRM HOMEPAGE
		...
		if(actualOHRMHomePage_URL.equals(expectedOHRMHomePage_URl))
		{
			...
			{
					System.out.println("HomePage Titles Are Not Matching-FAIL ");
					Cell homepageTitleResult=sheetRow.createCell(9);
					homepageTitleResult.setCellValue("HomePage Titles Are Not Matching-PASS");
	        ...
	        System.out.println();
	        System.out.println();
			FileOutputStream testResults= new FileOutputStream("./src/com/OHRMExcelWorkBooks/LogInTestResults3.xlsx");
